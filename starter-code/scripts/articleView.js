...
// Called in new.html, since the code below is required to add event listener to the form, which then gathers and exports the value into the preview window.
articleView.initNewArticlePage = () => {
  ...
  // LOOK BACK ON TEXTBOOK FOR EVENT LISTENERS --no parenthees? 
...
// This is called in index.html, since the functions here are used to handle interactions in the index page, not new.html page.
